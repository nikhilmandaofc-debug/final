...
def load_users(cursor, conn):
    ...
    users_data = [
        ...
        ("doctor2@hospital.com", "hashed_pwd_125", "manager"),
        ("nurse1@hospital.com", "hashed_pwd_126", "manager"),
        ("nurse2@hospital.com", "hashed_pwd_127", "manager"),
        ("receptionist@hospital.com", "hashed_pwd_128", "manager"),
        ("technician@hospital.com", "hashed_pwd_129", "manager"),
        ("supervisor@hospital.com", "hashed_pwd_130", "manager"),
    ]
